...
// Page de connexion via Magic Link WhatsApp
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-banner {
          ...
          color: #E07B54; font-size: 0.83rem;
          margin-bottom: 20px;
        }
        ...
        .form-input {
          ...
          color: #EDE8DC; font-size: 0.95rem; font-family: inherit;
        ...
        .debug-link {
          margin-top: 16px; padding: 10px; background: #122019;
          border-radius: 8px; font-size: 0.72rem; word-break: break-all; color: #C9A84C;
        }
