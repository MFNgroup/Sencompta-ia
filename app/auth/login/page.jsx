    ...
    <div className="login-page">
      <div className="login-deco">
        ...
        <div className="deco-disclaimer">
          ⚠️ SenCompta IA est un assistant automatisé. Ses analyses ne remplacent pas un expert-comptable agréé.
        </div>
      </div>
        ...
        <div className="login-card">
          {!sent ? (
            <>
              ...
              {errorKey && (
                <div className="error-banner">⚠ {ERROR_MESSAGES[errorKey] || 'Erreur de connexion.'}</div>
              )}
              ...
              <div className="cgu-wrap">
                <label className="cgu-label">
                  ...
                  <span>
                    ...
                    <a href="/mentions-legales" target="_blank" className="cgu-link">mentions légales</a>
                    {' '}et la{' '}
                    <a href="/confidentialite" target="_blank" className="cgu-link">politique de confidentialité</a>.
                    Je comprends que SenCompta IA est un <strong>assistant automatisé</strong> et ne remplace pas un expert-comptable agréé.
                  </span>
                </label>
              </div>

              <button className="btn-primary" onClick={handleSubmit} disabled={loading || !accepted}>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-deco { background: linear-gradient(160deg, #122019 0%, #0D1B14 60%); position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: center; padding: 60px 56px; }
        .deco-pattern { position: absolute; inset: 0; background-image: repeating-linear-gradient(0deg, transparent, transparent 39px, #1E3328 40px), repeating-linear-gradient(90deg, transparent, transparent 39px, #1E3328 40px); opacity: 0.4; }
        ...
        .deco-disclaimer { position: relative; z-index: 1; margin-top: 32px; padding: 12px 16px; background: rgba(224,123,84,0.08); border: 1px solid rgba(224,123,84,0.2); border-radius: 8px; font-size: 0.75rem; color: #E07B54; line-height: 1.5; }
        ...
        .cgu-wrap { margin-bottom: 16px; }
        .cgu-label { display: flex; align-items: flex-start; gap: 10px; cursor: pointer; font-size: 0.8rem; color: #8A9E8F; line-height: 1.6; }
        .cgu-checkbox { width: 16px; height: 16px; min-width: 16px; margin-top: 3px; accent-color: #C9A84C; cursor: pointer; }
        .cgu-link { color: #C9A84C; text-decoration: underline; }
        .cgu-link:hover { color: #EDE8DC; }
