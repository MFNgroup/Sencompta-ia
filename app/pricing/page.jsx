...
// Page de tarification avec intégration PayTech.sn
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .plan-card.popular {
          ...
          background: linear-gradient(160deg, #1A2E20, #122019);
        }
        .plan-card::before {
          content: '';
        ...
        .popular-tag {
          ...
          color: #C9A84C; font-size: 0.65rem; text-transform: uppercase;
        ...
        .price-amount {
          ...
          font-size: 2.4rem; color: var(--plan-color);
        }
        ...
        .top-nav {
          ...
          padding-bottom: 20px; border-bottom: 1px solid #1E3328;
        }
        .nav-logo { font-family: 'Playfair Display', serif; color: #C9A84C; font-size: 1.3rem; }
        .nav-links { display: flex; gap: 20px; }
        .nav-link { font-size: 0.85rem; color: #8A9E8F; text-decoration: none; }
        .nav-link:hover { color: #EDE8DC; }
        .nav-cta {
          background: rgba(201,168,76,0.1); border: 1px solid rgba(201,168,76,0.3);
          color: #C9A84C; border-radius: 8px; padding: 6px 14px;
              ...
              <div className="plan-features">
                {plan.features.map((f, i) => (
                  <div key={i} className="feature-row">
                    <span className={`feature-check ${f.ok ? 'ok' : 'no'}`}>
                      {f.ok ? '✓' : '–'}
                    </span>
          ...
          {[
            {
              ...
              a: "Enregistrez notre numéro WhatsApp, puis envoyez vos opérations en texte ou vocal. L'IA comprend le français et le wolof. Ex : \"vendu tissus 25000\" ou \"bind légumes 8500\".",
            },
            {
              q: 'Puis-je changer de plan en cours d\'abonnement ?',
              a: "Oui. Passer au Premium prolonge votre accès Premium immédiatement. Le reliquat de votre plan Standard est pris en compte.",
            },
            {
              q: 'Mes données sont-elles sécurisées ?',
              a: "Vos données sont hébergées en Europe sur des serveurs sécurisés. La connexion est chiffrée (HTTPS). Nous n'accédons jamais à vos données sans votre accord.",
            },
            {
